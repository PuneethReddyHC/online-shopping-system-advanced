...
include("../db.php");
$user_id=strip_tags(mysqli_real_escape_string($con, $_REQUEST['user_id']));
...
{
$user_name=strip_tags(mysqli_real_escape_string($con, $_POST['email']));
$user_password=strip_tags(mysqli_real_escape_string($con, $_POST['password']));
