...
<html lang="en">
	...
	<body>
		...
		<header>
			...
			<div id="top-header">
				<div class="container">
					...
					<ul class="header-links pull-right">
						...
						<li><div class="dropdownn">
                                  <a href="#" class="dropdownn" data-toggle="modal" data-target="#myModal" ><i class="fa fa-user-o"></i><?php echo "HI ".$_SESSION["name"]; ?></a>
			...
			<!-- /TOP HEADER -->
			<div class="modal fade" id="profiles" role="dialog">
						...
						<div class="col-md-6">
							<div class="header-search">
								<form>
									...
									<input  type="text" class="input" placeholder="Search here" id="search">
